...
Docker Scout helps monitor and secure your images across environments.
...
📖 **Full Guide:** See [DOCKER_SCOUT_SETUP.md](./DOCKER_SCOUT_SETUP.md) for detailed instructions.
